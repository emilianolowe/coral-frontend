            ...
            <div className="container mt-5">
                <div className="row">
                    <div className="col-md-2 p-4">
                        <br></br>
                        <svg className="bi bi-house-door-fill" width="5em" height="5em" viewBox="0 0 16 16" fill="#ff7262" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="row">
                    <div className="col-md-2 p-4">
                        <svg class="bi bi-star-fill" width="5em" height="5em" viewBox="0 0 16 16" fill="#ff7262" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="row">
                    <div className="col-md-2 p-4">
                        <svg className="bi bi-people-fill" width="5em" height="5em" viewBox="0 0 16 16" fill="#ff7262" xmlns="http://www.w3.org/2000/svg">
