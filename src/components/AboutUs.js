        ...
        return (
            <div className="container about-us">
                <div className="row">
                    ...
                    <br></br>
                        <svg className="bi bi-house-door-fill" width="2em" height="2em" viewBox="0 0 16 16" fill="#ff7262" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="row">
                    <div className="col-md-1 offset-1 p-4">
                        <svg className="bi bi-star-fill" width="2em" height="2em" viewBox="0 0 16 16" fill="#ff7262" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="row">
                    <div className="col-md-1 offset-1 p-4">
                        <svg className="bi bi-people-fill" width="2em" height="2em" viewBox="0 0 16 16" fill="#ff7262" xmlns="http://www.w3.org/2000/svg">
